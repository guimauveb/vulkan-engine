...
pub unsafe fn create_descriptor_set_layout(device: &Device, data: &mut EngineData) -> Result<()> {
...
pub unsafe fn create_pipeline(device: &Device, data: &mut EngineData) -> Result<()> {
    // Stages
